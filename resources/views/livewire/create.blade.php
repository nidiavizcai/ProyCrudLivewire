...
<div wire:ignore.selt class="modal fade" id="addStudentModal" tabindex="-1"  role="dialog" aria-labelledby="addStudentModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content bg-secondary">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="addStudentModal">Agregar Nuevo Estudiante</h5>
            ...
            <div class="modal-footer bg-primary">
                ...
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" wire:click.prevent="store()">Agregar Estudiante</button>
            </div>
        </div>
    </div>
</div>
